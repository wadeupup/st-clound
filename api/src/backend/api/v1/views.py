...
ACCEPT_LANGUAGE_VARY_DECORATOR = vary_on_headers("Accept-Language")
...
@method_decorator(CACHE_DECORATOR, name="list")
@method_decorator(CACHE_DECORATOR, name="retrieve")
@method_decorator(ACCEPT_LANGUAGE_VARY_DECORATOR, name="list")
@method_decorator(ACCEPT_LANGUAGE_VARY_DECORATOR, name="retrieve")
