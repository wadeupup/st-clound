...
export const DeleteForm = ({
  ...
  async function onSubmitClient(values: z.infer<typeof formSchema>) {
    ...
    if (data?.errors && data.errors.length > 0) {
      ...
      toast({
        variant: "destructive",
        title: t.users.deleteModal.somethingWentWrong,
        description: errorMessage,
      });
    } else {
      toast({
        title: t.users.deleteModal.success,
        description: t.users.deleteModal.userRemoved,
      });
    }
      ...
      <form onSubmit={form.handleSubmit(onSubmitClient)}>
        ...
        <div className="flex w-full justify-end gap-4">
          ...
          >
            ...
            {isLoading ? t.users.deleteModal.loading : t.users.deleteModal.delete}
          </Button>
        </div>
      </form>
    </Form>
