...
export const ApiKeyLinkCard = () => {
  return (
    <LinkCard
      ...
      bodyText="API Key management is available in your User Profile. Create and manage API keys to authenticate with the ST Cloud API for automation and integrations."
      linkHref="/profile"
