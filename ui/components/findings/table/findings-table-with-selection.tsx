...
export function FindingsTableWithSelection({
  ...
  // Use useMemo with locale dependency to regenerate columns when language changes
  const columns = useMemo(
    () => getColumnFindings(rowSelection, selectableRowCount, t),
    [rowSelection, selectableRowCount, t, locale],
  );
