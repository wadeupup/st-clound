...
export const SeverityBadge = ({ severity }: { severity: Severity }) => {
  ...
  const severityLabels: Record<Severity, string> = {
    critical: t.overview.severity.critical,
    high: t.overview.severity.high,
    medium: t.overview.severity.medium,
    low: t.overview.severity.low,
    informational: t.overview.severity.informational,
  };
