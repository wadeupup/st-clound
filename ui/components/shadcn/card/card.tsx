...
const cardVariants = cva("flex flex-col gap-6 rounded-xl border", {
  variants: {
    variant: {
      default: "",
      base: "border-slate-200 bg-white/80 backdrop-blur-sm shadow-lg dark:border-slate-800 dark:bg-slate-900/80 px-[18px] pt-3 pb-4",
      inner:
        "rounded-[12px] backdrop-blur-sm border-slate-200 bg-slate-50/50 dark:border-slate-700 dark:bg-slate-800/50",
    },
    padding: {
      default: "",
      sm: "px-3 py-2",
