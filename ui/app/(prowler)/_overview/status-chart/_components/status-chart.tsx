...
export const StatusChart = ({
  ...
  const handleSegmentClick = (dataPoint: DonutDataPoint) => {
    ...
    if (dataPoint.name === t.overview.statusChart.failFindings) {
      params.set("filter[status__in]", "FAIL");
    } else if (dataPoint.name === t.overview.statusChart.passFindings) {
  ...
  const donutData: DonutDataPoint[] = [
    {
      name: t.overview.statusChart.failFindings,
    ...
    {
      name: t.overview.statusChart.passFindings,
  ...
  return (
    ...
    >
      <CardHeader>
        <CardTitle>{t.overview.statusChart.title}</CardTitle>
      </CardHeader>
        ...
        <div className="mx-auto h-[172px] w-[172px]">
          <DonutChart
            ...
            centerLabel={{
              ...
              label: t.overview.statusChart.totalFindings,
            }}
