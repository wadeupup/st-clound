  ...
  const selectedLabel = () => {
    ...
    return (
      <span className="truncate">
        {selectedTypes.length} {t.overview.providerSelector.providersSelected}
      </span>
    );
  };
        ...
        <MultiSelectContent search={false}>
          {availableTypes.length > 0 ? (
            <>
              ...
              >
                {t.overview.providerSelector.selectAll}
              </div>
            ...
            <div className="px-3 py-2 text-sm text-slate-500 dark:text-slate-400">
              {t.overview.providerSelector.noProvidersAvailable}
            </div>
          )}
        </MultiSelectContent>
      </MultiSelect>
